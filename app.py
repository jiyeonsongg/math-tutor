    ...
    st.markdown(
        ...
        <style>
          :root {
            ...
            --pastel-coral: #f5a097;
            --pastel-coral-deep: #e8877f;
            --pastel-text: #2d3436;
          }
          /* Slider thumb — warm coral (filled track uses theme primaryColor) */
          ...
          label[data-baseweb="checkbox"] [data-testid="stMarkdownContainer"] p {
            background-color: transparent !important;
          }
          label[data-baseweb="checkbox"] > div:first-of-type > div:first-child {
            border-color: var(--pastel-coral-deep) !important;
          }
          label[data-baseweb="checkbox"]:has(input:checked) > div:first-of-type > div:first-child {
            background-color: var(--pastel-coral) !important;
            border-color: var(--pastel-coral-deep) !important;
          }
          .stApp {
